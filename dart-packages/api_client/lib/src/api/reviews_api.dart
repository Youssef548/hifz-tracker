...
import 'package:hifz_api_client/src/api_util.dart';
...
class ReviewsApi {
  ...
  Future<Response<ReviewListResponseOutput>> reviewsControllerList({
    ...
    ReviewListResponseOutput? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ReviewListResponseOutput),
            ) as ReviewListResponseOutput;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ReviewListResponseOutput>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
